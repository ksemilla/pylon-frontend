...
import StockVendorForm from "./StockVendorForm"

const StockVendorInline = ({ vendor }) => {
  ...
  return (
    <div className="divide-y divide-gray-200 bg-white border border-gray-200 rounded-md">
      ...
      <div className="p-2">
        <StockVendorForm initialValues={vendor} onSubmit={onSubmit} />
      </div>
...
export default StockVendorInline