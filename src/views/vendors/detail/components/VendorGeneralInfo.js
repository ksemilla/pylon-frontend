import { deleteVendor, updateVendor } from "api/vendors"
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete this vendor? <br/><br />
                        Code: <span className="font-medium text-gray-700">{vendor?.code}</span> <br/>
