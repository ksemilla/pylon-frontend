  ...
  return (
    <div className="divide-y divide-gray-200 bg-white border border-gray-200 rounded-md">
      <div className="flex justify-between items-center p-2">
        <h1 className="font-medium text-gray-600">ID {customer?.id}</h1>
        <button
          type="submit"
      ...
      <div className="p-2">
        <CustomerGeneralInfoForm initialValues={customer} onSubmit={onSubmit} />
      </div>
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                      Delete vendor {customer?.id}?
                    </Dialog.Title>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete this customer? <br/><br />
                        Code: <span className="font-medium text-gray-700">{customer?.code}</span> <br/>
                        Name: <span className="font-medium text-gray-700">{customer?.name}</span>
                      </p>
                    </div>
                  </div>
                </div>
